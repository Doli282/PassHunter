...
Revision ID: 6b7367c49edb
Revises: 
Create Date: 2025-04-19 11:32:13.111025
...
def upgrade():
    ...
    sa.Column('email', sa.String(length=256), nullable=False, comment='Email address for the account'),
    sa.Column('name', sa.String(length=256), nullable=True, comment="Account's name"),
