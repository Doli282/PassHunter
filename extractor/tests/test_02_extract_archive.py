...
# Tests generated by Pycharm IDE with functionality "Generate Unit Tests"
...
@mock.patch('extractor.DOWNLOAD_PATH', '/tmp/')
class TestExtractor(unittest.TestCase):
    ...
    def test_extract_archive(self, mock_send_task, *args, **kwargs):
    ...
    def test_extract_archive_mock(self, mock_is_archive, mock_extract_archive, mock_os_walk, mock_shutil_move, mock_send_task, mock_os_remove, *args, **kwargs):
    ...
    def test_extract_archive_invalid_archive(self, mock_is_archive, mock_extract_archive, mock_logging_error, mock_os_remove, *args, **kwargs):
        """Run the extract_archive function with mocks. - invalid archive"""
